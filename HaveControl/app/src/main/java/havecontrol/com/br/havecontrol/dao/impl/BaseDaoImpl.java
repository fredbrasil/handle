...
import br.com.havecontrol.common.ConstantDatabase;
import br.com.havecontrol.common.util.NumberUtil;
import br.com.havecontrol.dao.BaseDao;
...
public class BaseDaoImpl<T extends EntityBase> extends SQLiteOpenHelper implements BaseDao<T>{	
	...
	public void onCreate(SQLiteDatabase database) {	   
		...
		/* TRIGGER */
		Log.i("Create Trigger: ", ConstantDatabase.createFK_Place_RevenueExpenseType());
		database.execSQL(ConstantDatabase.createFK_Place_RevenueExpenseType());

		Log.i("Create Trigger: ", ConstantDatabase.createFK_PlaceMaps_Place());
		database.execSQL(ConstantDatabase.createFK_PlaceMaps_Place());

		Log.i("Create Trigger: ", ConstantDatabase.createFK_Cost_RevenueExpenseType());
		database.execSQL(ConstantDatabase.createFK_Cost_RevenueExpenseType());
	...
	public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {	  
		...
		/* TRIGGER */
		Log.i("Drop Trigger: ", ConstantDatabase.dropFK_Place_RevenueExpenseType());
		database.execSQL(ConstantDatabase.dropFK_Place_RevenueExpenseType());
		...
		Log.i("Drop Trigger: ", ConstantDatabase.dropFK_Cost_RevenueExpenseType());
		database.execSQL(ConstantDatabase.dropFK_Cost_RevenueExpenseType());
		...
		Log.i("Drop Table: ", ConstantDatabase.dropTableRevenueExpenseType());
		database.execSQL(ConstantDatabase.dropTableRevenueExpenseType());
